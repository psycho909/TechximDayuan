<template>
    <div class="main-wrap" role="main">
        ...
        <!-- 資料表顯示 -->
        <div id="searchResults" class="x_panel jsgrid data-panel Index-table" style="max-width: 1650px; min-height: 800px; position: relative; height: auto; width: 1385px;display: none;">
            <!-- 資料表標題 -->
